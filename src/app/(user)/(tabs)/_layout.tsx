...
export default function UserTabs() {
  return (
    ...
    >
      <Tabs.Screen name="index" options={{ title: "Browse", headerShown: false, tabBarIcon: tab("search") }} />
      <Tabs.Screen name="enquiries" options={{ title: "Enquiries", tabBarIcon: tab("chatbubbles") }} />
      <Tabs.Screen name="account" options={{ title: "Account", tabBarIcon: tab("person") }} />
    </Tabs>
  );
}
