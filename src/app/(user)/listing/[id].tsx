...
import { Screen, Card, H1, H2, Muted, Body, Badge, Row, Loading, ErrorText, money } from "@/components/ui";
  ...
  return (
    <Screen>
      ...
      <Card>
        ...
        <Muted>Contact the owner from the website to start an enquiry.</Muted>
      </Card>
    </Screen>
  );
}
